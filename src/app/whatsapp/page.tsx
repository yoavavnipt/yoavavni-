...
const T = [
  ...
  { id:'welcome_online', l:'ברוך הבא — טיפול אונליין', i:'💻', c:'#7c3aed',
    getMsg: (p:any,d:string,t:string)=>`בוקר טוב ${p.first_name} ${p.last_name} 😊\n\nקבענו טיפול פיזיותרפיה אונליין בתאריך ${d} בשעה ${t}\nהטיפול אורך כ-40 דקות.\nעלות 360 ₪ לטיפול.\n\nלפני הטיפול אשלח לך לינק לחיבור (Google Meet).\nנא להיות במקום שקט עם מקום פתוח לתנועה.\n\nביטול או שינוי יתבצע עד יום לפני ב-10:00 — מעבר לכך ידרש חיוב מלא.${FOOTER}`}, f:(p:any,d:string,t:string)=>`שלום ${p.first_name} ${p.last_name} 😊\n\nתזכורת — יש לך תור מחר ${d} בשעה ${t}.\n\n📍 רחוב התרשיש 8, גילון\nלשינוי או ביטול — עד הערב ב-10:00.\n\nמחכים לך! 🙏\nקליניקת יואב אבני`},
  { id:'payment', l:'בקשת תשלום', i:'💳', c:'#0b8a5e', f:(p:any,_d:string,_t:string,a?:string)=>{
    ...
    return `שלום ${p.first_name} ${p.last_name} 😊\n\nתזכורת לתשלום עבור טיפול.\nסכום: ₪${a||'___'}${link ? `\n\n💳 לתשלום באשראי:\n${link}` : '\n\n💳 לתשלום באשראי — יישלח לינק בנפרד'}\n\nתודה! 🙏\nקליניקת יואב אבני`
  }},
  ...
  { id:'meet_link', l:'לינק לטיפול אונליין', i:'🔗', c:'#7c3aed', f:(p:any,d:string,t:string)=>`שלום ${p.first_name} ${p.last_name} 😊\n\nתזכורת — יש לך טיפול אונליין היום ${d} בשעה ${t}.\n\n🔗 לינק לחיבור:\n[הכנס לינק Google Meet כאן]\n\nנא להתחבר 2 דקות לפני השעה.\nלהיות במקום שקט עם מקום פתוח לתנועה.\n\nמחכה לך! 💪\nיואב אבני PT`},
