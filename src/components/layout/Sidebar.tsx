  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '18px 16px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', marginTop: '2px' }}>קליניקת יואב אבני</div>
      </div>
        ...
        {NAV.map(section => {
          ...
          return (
            <div key={section.section}>
              <div style={{ padding: '12px 16px 4px', fontSize: '10px', fontWeight: '700', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                {section.section}
              </div>
      ...
      {(isAdmin || isSecretary) && (
        <div style={{ padding: '10px 12px', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
          <Link href="/patients/new" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '9px', background: '#3eb8e5', borderRadius: '8px', color: '#fff', fontSize: '12px', fontWeight: '700', textDecoration: 'none' }}>
            + מטופל חדש
          </Link>
        </div>
      )}
      ...
      <div style={{ padding: '12px 16px', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', gap: '10px' }}>
        <div style={{ width: '32px', height: '32px', background: '#3eb8e5', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px', fontWeight: '800', color: '#fff', flexShrink: 0 }}>
          {user?.name?.[0] || 'י'}
        </div>
        ...
        <button onClick={logout} style={{ background: 'rgba(255,255,255,0.1)', border: 'none', color: 'rgba(255,255,255,0.6)', width: '28px', height: '28px', borderRadius: '6px', cursor: 'pointer', fontSize: '14px', flexShrink: 0 }} title="יציאה">
          🚪
        </button>
      </div>
    </div>
